...
\begin{lstlisting}
$https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/Varun_Singing.wav
\end{lstlisting}
\item 
\label{Python code}
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/2_2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
%
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/5.4.py   
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/6.1.py 
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/fft.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/fft_python.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/6.4_time.c
\end{lstlisting}
The below python code extracts the data from these text files and plots Time vs $n$ for comparison.
\begin{lstlisting}
https://github.com/Varunryaliiith/Audio_Filter/blob/main/codes/6.4_plot.py
\end{lstlisting}
\begin{figure}[H]
\centering
